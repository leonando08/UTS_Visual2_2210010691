...
//kode simpan
  ...
  else if DataModule2.Zsatuan.Locate('name', edt1.Text, []) then
  begin
...
else if (edt1.Text = DataModule2.Zsatuan.FieldByName('name').AsString) and (edt2.Text = DataModule2.Zsatuan.FieldByName('diskripsi').AsString) then
begin
